/*
 ...
 Source Server         : 154.193.216.69
 Source Server Type    : MySQL
 Source Server Version : 80032 (8.0.32-X-Cluster-8.4.19-20250825)
 Source Host           : 154.193.216.69:4886
 Source Schema         : aurora

 Target Server Type    : MySQL
 Target Server Version : 80032 (8.0.32-X-Cluster-8.4.19-20250825)
 File Encoding         : 65001

 Date: 21/04/2026 12:32:32
*/
...
CREATE TABLE `t_friend_link`  (
  ...
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `is_review` int NOT NULL COMMENT '0表示未审核，1表示审核通过，2表示审核不通过',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `t_system_config` VALUES (1, 'website.url', NULL, '网站URL', '2026-01-01 17:12:30', '2026-04-21 04:31:58');
INSERT INTO `t_system_config` VALUES (2, 'website.name', NULL, '网站名称', '2026-01-01 17:12:30', '2026-04-21 04:31:58');
INSERT INTO `t_system_config` VALUES (3, 'website.message', NULL, '网站寄语', '2026-01-01 17:12:30', '2026-04-21 04:31:59');
INSERT INTO `t_system_config` VALUES (4, 'friendLink.url', NULL, '友链URL', '2026-01-01 17:12:30', '2026-04-21 04:32:00');
INSERT INTO `t_system_config` VALUES (5, 'friendLink.email', NULL, '友链邮箱', '2026-01-01 17:12:30', '2026-04-21 04:32:00');
INSERT INTO `t_system_config` VALUES (6, 'search.mode', NULL, '搜索模式', '2026-01-01 17:12:30', '2026-04-21 04:32:00');
INSERT INTO `t_system_config` VALUES (7, 'upload.mode', NULL, '上传模式', '2026-01-01 17:12:30', '2026-04-21 04:32:01');
INSERT INTO `t_system_config` VALUES (8, 'upload.oss.url', NULL, 'OSS URL', '2026-01-01 17:12:30', '2026-04-21 04:32:02');
INSERT INTO `t_system_config` VALUES (9, 'upload.oss.endpoint', NULL, 'OSS Endpoint', '2026-01-01 17:12:30', '2026-04-21 04:32:02');
INSERT INTO `t_system_config` VALUES (10, 'upload.oss.accessKeyId', NULL, 'OSS AccessKeyId', '2026-01-01 17:12:30', '2026-04-21 04:32:03');
INSERT INTO `t_system_config` VALUES (11, 'upload.oss.accessKeySecret', NULL, 'OSS AccessKeySecret', '2026-01-01 17:12:30', '2026-04-21 04:32:03');
INSERT INTO `t_system_config` VALUES (12, 'upload.oss.bucketName', NULL, 'OSS BucketName', '2026-01-01 17:12:30', '2026-04-21 04:32:04');
INSERT INTO `t_system_config` VALUES (13, 'upload.minio.url', NULL, 'MinIO URL', '2026-01-01 17:12:30', '2026-04-21 04:32:04');
INSERT INTO `t_system_config` VALUES (14, 'upload.minio.endpoint', NULL, 'MinIO Endpoint', '2026-01-01 17:12:30', '2026-04-21 04:32:05');
...
-- ----------------------------
-- Table structure for t_visitor_area
-- ----------------------------
