...
<!--              <em># {{ tag.tagName }}</em>-->
<!--                  <em>#{{ tag.tagName.length > 6 ? tag.tagName.slice(0, 6) + '...' : tag.tagName }}</em>-->
               <em>
      #{{
                   article.tags.length === 6 ? tag.tagName.slice(0, 2) + (tag.tagName.length > 2 ? '...' : '') :
                       article.tags.length === 5 ? tag.tagName.slice(0, 3) + (tag.tagName.length > 3 ? '...' : '') :
                       article.tags.length === 4 ? tag.tagName.slice(0, 5) + (tag.tagName.length > 7 ? '...' : '') :
                       article.tags.length === 3 ? tag.tagName.slice(0, 7) + (tag.tagName.length > 10 ? '...' : '') :
                           article.tags.length === 2 ? tag.tagName.slice(0, 15) + (tag.tagName.length > 15 ? '...' : '') :
                               tag.tagName
                 }}
    </em>
            </li>
        ...
        <h2 class="article-title" v-if="article.articleTitle">
          <a>
