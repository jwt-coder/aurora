...
// 不设置baseURL，让axios使用相对路径
// 浏览器会自动使用当前页面的完整URL（包括正确的端口）
...
export default {
  ...
  submitFriendLink: (params: any) => {
    return axios.post('/api/add/links', params)
  },
  ...
  sendValidationCode: (params: any) => {
    return axios.post('/api/users/code', params)
  },
